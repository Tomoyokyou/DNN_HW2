...
#TRAIN=/home/jason/MachineLearningDNNCourse/model/trainFtre_orig_256_acc60.txt
#TEST=/home/jason/MachineLearningDNNCourse/model/testFtre_orig_256_acc60.txt

DIM=69
FEATTYPE=0
#MODEL=./model/test_0.1_0.05.mdl
#MODEL=./model/hidden_orig_${C}_${epsilon}_acc60.mdl
#OUTPUT=./model/hidden_orig_${C}_${epsilon}_acc60.seq
#=====================
#TRAIN=/home/hui/model/u10.ark
MODEL=./model/halfloss.mdl
OUTPUT=./model/halfloss.seq
mkdir -p model
mkdir -p log
